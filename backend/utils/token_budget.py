...
class TokenBudget:
    ...
    def get_adjusted_limit_for_agent(
        ...
        from backend.utils.adaptive_context_config import calculate_agent_token_limit, get_agent_strategy
...
def get_token_budget_for_model(model_name: Optional[str] = None) -> TokenBudget:
    ...
    MODEL_LIMITS = {
        # OpenAI o3 series (200K context) - reasoning models
        ...
        # OpenAI o1 series (128K-200K context) - reasoning models
