...
class ConversationFlowManager:
    ...
    def __init__(self, db_session=None):
        ...
        if db_session:
            try:
                from backend.conversation.self_learning import SelfLearningSystem
    ...
    async def _execute_pm_step(
        ...
        from backend.prompts.pm_planner_model import PMStepType
    ...
    async def generate_pm_plan(
        ...
        try:
            ...
            from backend.prompts.pm_planner_model import PMPlan, PMStepType
    ...
    def _build_execution_context(
        ...
        from backend.prompts.pm_planner_model import ExecutionContext
    ...
    async def _generate_revised_plan(
        ...
        try:
            from backend.llms.llm import get_llm_by_type
            from backend.prompts.template import get_prompt_template
            from backend.prompts.pm_planner_model import PMPlan
    ...
    async def _handle_sprint_planning(
        ...
        try:
            from backend.handlers import SprintPlanner
...
- project_id: UUID of the project"""
    ...
    def _db_project_to_pm(self, project) -> 'PMProject':
        ...
        from pm_providers.models import PMProject
