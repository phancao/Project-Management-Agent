    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav: "absolute z-10 flex items-center justify-between w-full left-0 top-3 px-1",
                button_previous: cn(
