...
export function TeamList({ teams, selectedTeamId, onTeamSelect, onCreateTeam, onDeleteTeam }: TeamListProps) {
    ...
    return (
        <>
            <div className="flex flex-col h-full bg-gradient-to-b from-slate-900 to-slate-950 rounded-2xl border-0 shadow-2xl shadow-indigo-500/5 overflow-hidden">
                {/* Premium Header */}
                <div className="relative p-4 border-b border-slate-800/50 bg-gradient-to-r from-indigo-500/10 via-violet-500/5 to-transparent">
                    ...
                    <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h3 className="font-bold text-base text-white">Teams</h3>
                        </div>
                        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                            ...
                            <DialogContent className="bg-slate-900 border-slate-800">
                                ...
                                <DialogFooter>
                                    <Button variant="outline" onClick={() => setIsCreateOpen(false)} className="border-slate-700 text-slate-300 hover:bg-slate-800">Cancel</Button>
            ...
            <Dialog open={!!deleteDialogTeam} onOpenChange={(open) => !open && setDeleteDialogTeam(null)}>
                <DialogContent className="bg-slate-900 border-slate-800">
                    ...
                    <DialogFooter>
                        <Button variant="outline" onClick={() => setDeleteDialogTeam(null)} className="border-slate-700 text-slate-300 hover:bg-slate-800">
                            Cancel
                        </Button>
                        <Button
                            variant="destructive"
