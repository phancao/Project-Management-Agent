"""
Shared data models for analytics and chart generation.

These models provide a consistent structure for chart data that can be
easily serialized to JSON and consumed by:
- PM Agent frontend and tools
- Meeting Notes Agent for meeting analytics
...
class WorkItemType(str, Enum):
    ...
    EPIC = "epic"
    SUBTASK = "subtask"
    # Meeting-specific work item types
...
class WorkItem(BaseModel):
    ...
    # Optional meeting link for items created from meetings
    source_meeting_id: Optional[str] = Field(None, description="Source meeting ID if created from meeting")
